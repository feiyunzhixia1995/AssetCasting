...
UCLASS()
class VTMHOTUPDATE_API UAsyncDownloadFile : public UBlueprintAsyncActionBase
{
...
protected:
	...
	void StartSubTaskDownload(TSharedRef<FSubHttpTask, ESPMode::ThreadSafe>  SubHttpTask);
...
protected:
	...
	TSharedPtr<IHttpRequest, ESPMode::ThreadSafe>  FileSizeRequest;
	TArray<TSharedPtr<FSubHttpTask, ESPMode::ThreadSafe>>	SubTasks;
